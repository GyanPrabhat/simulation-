...
rs5 = reward_s5[0]
#print("Reward for the spin-5 is",rs5)
#print("Result of spins were",y1,y2,y3,y4,y5)
print ("\n") 
print("Result of spin-1 =",y1)
print("Result of spin-2 =",y2)
print("Result of spin-3 =",y3)
print("Result of spin-4 =",y4)
print("Result of spin-5 =",y5)
print ("\n") 
print("reward for spin-1 is:",reward_s1)
print("reward for spin-2 is:",rs2)
print("reward for spin-3 is:",rs3)
print("reward for spin-4 is:",rs4)
print("reward for spin-5 is:",rs5)
Tot_r = reward_s1 + rs2 + rs3 + rs4 + reward_s5
Tot_reward = Tot_r[0]
print("Total reward at the end of the simulation is:",Tot_reward)
